...
•	'Data_Analytics_in_Motorsport_Predicting_Formula_1_Race_Outcomes.ipynb' This notebook contains the complete analysis pipeline:
...
The dataset includes information about races, drivers, constructors, qualifying, sprint races and pit stops. The notebook downloads the data using kagglehub.
